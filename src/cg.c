...
// Clear the primary & secondary registers
...
//Pop secondary register
void cgpop2(void)	{ gen("popq\t%rcx"); }

// Swap primary/secondary registers
void cgswap(void)	{ gen("xchgq\t%rax,%rcx"); }

// Operations on primary & secondary registers
...
// Define byte, word, pointer, char values

...
void cgldswtchval(void);	// Put the value to switch on into a suitable register
...
void cgretvalue(void);		// Copy primary register into return register
void cgfreeregs();		// Free all registers
...
void cgunldinc(void);		// Free increment pointer
